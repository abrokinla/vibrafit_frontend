  ...
  useEffect(() => {
    ...
    fetchPendingSubscriptions()
      ...
      .catch((error) => toast({ 
        ...
        description: error.message || t('toastErrorFetch'), 
        variant: "destructive" 
      }))
    ...
    try {
      ...
      if (result.success) {
        ...
        toast({
          ...
          description: t('toastSuccessDescription', { status: status === 'active' ? t('approved') : t('rejected') }),
        });
      } else {
              ...
              <CardHeader className="flex-row items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <CardDescription className="flex items-center gap-1 text-xs">
                    ...
                    {t('requestedTime', { 
                      time: formatDistanceToNow(new Date(req.requested_at), { 
                        addSuffix: true, 
                        locale: es // Use the locale from date-fns
                      }) 
                    })}
                  </CardDescription>
                </div>
